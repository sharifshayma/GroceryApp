 ...
 * All icons use viewBox="0 0 24 24", round linecaps/linejoins, strokeWidth 2.
...
export function IconLists({ className = 'w-7 h-7' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="3" width="18" height="18" rx="3" />
      <line x1="7.5" y1="8.5" x2="7.5" y2="8.5" strokeWidth={3} />
      <line x1="11" y1="8.5" x2="17" y2="8.5" />
      <line x1="7.5" y1="12" x2="7.5" y2="12" strokeWidth={3} />
      <line x1="11" y1="12" x2="17" y2="12" />
      <line x1="7.5" y1="15.5" x2="7.5" y2="15.5" strokeWidth={3} />
...
export function IllustrationNoLists({ className = 'w-24 h-24' }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none">
      <rect x="25" y="15" width="70" height="90" rx="10" fill="#FFF8E7" stroke="#F28B30" strokeWidth="3" />
      <rect x="20" y="10" width="10" height="20" rx="3" fill="#E8C840" />
      <rect x="90" y="10" width="10" height="20" rx="3" fill="#E8C840" />
      <line x1="40" y1="42" x2="80" y2="42" stroke="#F2A665" strokeWidth="3" strokeLinecap="round" />
      <line x1="40" y1="55" x2="72" y2="55" stroke="#F2A665" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="40" y1="68" x2="76" y2="68" stroke="#F2A665" strokeWidth="3" strokeLinecap="round" opacity="0.4" />
...
export function IllustrationNoItems({ className = 'w-24 h-24' }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none">
      <rect x="25" y="30" width="70" height="65" rx="8" fill="#FFF8E7" stroke="#F28B30" strokeWidth="3" />
      <path d="M25 38h70" stroke="#F28B30" strokeWidth="3" />
      <rect x="38" y="20" width="44" height="18" rx="6" fill="none" stroke="#E8611A" strokeWidth="3" />
      <path d="M48 55l6 6 12-12" stroke="#8BC34A" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="40" y1="76" x2="80" y2="76" stroke="#F2A665" strokeWidth="3" strokeLinecap="round" opacity="0.4" />
...
export function IllustrationNoResults({ className = 'w-24 h-24' }) {
  return (
    <svg className={className} viewBox="0 0 120 120" fill="none">
      <circle cx="52" cy="52" r="28" fill="#FFF8E7" stroke="#F28B30" strokeWidth="3" />
      <circle cx="52" cy="52" r="18" stroke="#F2A665" strokeWidth="2" strokeDasharray="4 4" />
      <line x1="72" y1="72" x2="98" y2="98" stroke="#F28B30" strokeWidth="4" strokeLinecap="round" />
      <path d="M45 50h14" stroke="#E8611A" strokeWidth="3" strokeLinecap="round" />
