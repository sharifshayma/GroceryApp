...
describe("markCheapest", () => {
  it("flags the min-price row per item", () => {
    const rows = [
      { entryId: "e1", itemId: "milk-1", item: "Milk", price: 7.5, store: "A", purchasedAt: "2026-08-01" },
      { entryId: "e2", itemId: "milk-1", item: "Milk", price: 6.9, store: "B", purchasedAt: "2026-08-02" },
      { entryId: "e3", itemId: "eggs-1", item: "Eggs", price: 12, store: "A", purchasedAt: "2026-08-01" },
    ];
  ...
  it("evaluates same-name items independently when itemId differs", () => {
    ...
    const rows = [
      { entryId: "e1", itemId: "milk-A", item: "Milk", price: 10, store: "A", purchasedAt: "2026-08-01" },
      { entryId: "e2", itemId: "milk-A", item: "Milk", price: 12, store: "B", purchasedAt: "2026-08-02" },
      { entryId: "e3", itemId: "milk-B", item: "Milk", price: 5, store: "C", purchasedAt: "2026-08-01" },
      { entryId: "e4", itemId: "milk-B", item: "Milk", price: 8, store: "D", purchasedAt: "2026-08-02" },
    ];
    const out = markCheapest(rows);
